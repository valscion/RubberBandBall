...
public class GroupObject {
	...
	/**
	 * Gets the polygon of this object, if it is a polygon object.
	 * 
	 * @author VesQ
	 * @throws SlickException
	 */
	public Polygon getPolygon() throws SlickException {
		if (!(objectType == ObjectType.POLYGON)) {
			throw new SlickException("Object isn't a polygon object");
		}
		if (map == null) {
			throw new SlickException(
					"Object doesn't belong to a map of type TiledMapPlus");
